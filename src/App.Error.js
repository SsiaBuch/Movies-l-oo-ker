...
// import { API, getApiString, getApiTranding } from './components/api/data-API.js'

export class App.Error extends Component {
  constructor() {
    super();
    this.state = {
  ...
  //   getApiString(type, this.state.page).then(({ data }) => {
  //     const objToUpdate = {};
  //     objToUpdate[dataType[type]] = data.results
